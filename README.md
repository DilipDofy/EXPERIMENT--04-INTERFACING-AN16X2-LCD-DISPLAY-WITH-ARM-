...
int main(void)
{
  ...
  Lcd_PortType ports[] = { GPIOA, GPIOA, GPIOA, GPIOA };
     ...
     Lcd_cursor(&lcd, 0,1);
     Lcd_string(&lcd, "DILIP M P");
     Lcd_cursor(&lcd, 1,1);
     Lcd_string(&lcd, "212223230048");
  /* USER CODE END 2 */
...
![pic-1](https://github.com/user-attachments/assets/405faf1f-e9aa-435f-a712-7d0c1bf7a4a1)
...
![pic-2](https://github.com/user-attachments/assets/c8f4c7d2-b7af-43f2-8e06-1ecba2d9b860)
